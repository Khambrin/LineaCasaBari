...
if($num_indi)
{
	my $x='<li><p>'."Indirizzo n. 1</p>".'<input type="radio" name="indirizzo" value="1" checked/></li>';
	$tot=$tot.$x;
...
{	
	my $num_x=$index+1;
	my $x='<li><label id="acquisto-indirizzoLabel">'."Indirizzo n. $num_x </label>".'<input type="radio" name="indirizzo" value="'."$index".'"/></li>';
	$tot=$tot.$x;
